...
function auxiliaryHTMLtask3() {
	...
	divTask3.innerHTML = `
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/planets.jpg" width="640" height="360">
		  </figure>
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/sun.jpg" width="658" height="658">
		  </figure>
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/mercury.jpg" width="390" height="390">
		  </figure>
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/venus.jpg" width="390" height="390">
		  </figure>
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/earth.jpg" width="390" height="390">
		  </figure>
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/mars.jpg" width="390" height="390">
		  </figure>
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/jupiter.jpg" width="390" height="390">
		  </figure>
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/saturn.jpg" width="805" height="390">
		  </figure>
		  ...
		  <figure>
			<img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/uranus.jpg" width="390" height="390">
		  </figure>
		  ...
		  <p>Neptune (30.1 AU), though slightly smaller than Uranus, is more massive (equivalent to 17 Earths)
		   ...
		   <figure>
			 <img src="https://en.js.cx/task/load-visible-img/solution/placeholder.svg" data-src="https://en.js.cx/clipart/solar/neptune.jpg" width="390" height="390">
		   </figure>`;
	document.body.prepend(divTask3);
}
function solutionTask3() {
	forNodeSolution();
	function forNodeSolution () {
		divTask3.onload = setTimeout(uploadImg, 0);
		divTask3.onscroll = uploadImg;
		function uploadImg() {
			let imgNode = divTask3.querySelector('[data-src^="https://"]');
			if(imgNode) {
				let coordNode = imgNode.offsetTop - divTask3.scrollTop;
				if(coordNode < divTask3.offsetHeight) {
	...
	function forDocumentSolution () {
		window.onload = setTimeout(uploadImg, 0);
		window.onscroll = uploadImg;
		function uploadImg() {
			let imgNode = document.querySelector('[data-src^="https://"]');
			if(imgNode) {
				let coordNode = imgNode.offsetTop - window.pageYOffset;
				if(coordNode < Math.max(
